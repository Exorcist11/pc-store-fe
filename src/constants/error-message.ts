export const ERROR_API_MESSAGE: any = {
  ...
  UserStatusInactive:
    "Tài khoản đang bị khóa. Vui lòng liên hệ với quản trị viên hệ thống để được hỗ trợ.",
  EmailTemplateNotExist: "Email template không tồn tại, vui lòng thử lại sau.",
  ArticleRequiredFieldNotEmpty:
    "Gửi duyệt vui lòng điền đầy đủ các thông tin bắt buộc.",
...
export const ERROR_MESSAGE = {
  ...
  duplicateValue:
    "Index number or option name must be unique within one menu. Please check!!",
